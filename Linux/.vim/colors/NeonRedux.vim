" Vim color file
" NeonRedux
" Created by Thomas Boudreaux with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#292929"
let s:bg4="#3d3d3d"
let s:keyword="#4ef500"
let s:builtin="#f500d8"
let s:const= "#ffffff"
